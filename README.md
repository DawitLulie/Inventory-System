...
## Description
A simple console-based **Java Inventory System** that helps manage items in stock. Users can add, remove, display, and track items with their name, quantity, and price.
